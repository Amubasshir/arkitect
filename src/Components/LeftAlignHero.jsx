      ...
      <div className="relative z-10 w-full h-full lg:min-h-screen flex flex-col justify-end pb-20 px-6 sm:px-16 lg:px-20 mt-20">
        <div className="max-w-4xl mx-auto lg:mx-0 text-center lg:text-left text-white ">
          ...
          <h1 className="leading-2 mb-6 tracking-tight  font-bold mt-20">
            <span className="text-4xl sm:text-6xl md:text-xl lg:text-9xl font-medium font-[Zodiak]">
              INNOVATIVE
            </span>{' '}
            <br />
            <span className="font-semibold text-4xl sm:text-6xl md:text-8xl lg:text-9xl">
              DESIGN
            </span>
          </h1>

          {/* Description */}
          <p className="text-lg md:text-3xl  max-w-3xl font-medium mx-auto lg:mx-0 mb-12">
