...
export default function Footer() {
  ...
  return (
    <footer
      ref={footerRef}
      className="bg-black text-gray-300 py-16 px-4 sm:px-8 lg:px-16 mt-8"
    >
      <div ref={footerContentRef} className="max-w-7xl mx-auto flex flex-col">
        {/* Top Section */}
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-8 lg:gap-16 pb-12 md:pb-16 lg:pb-20 border-b border-gray-700">
          {/* Column 1 */}
