...
import { FaTwitter, FaInstagram } from 'react-icons/fa'; // React Icons ব্যবহার করা হয়েছে

export default function Footer() {
  return (
    <footer className="bg-gray-900 text-gray-300 py-16 px-4 sm:px-8 lg:px-16">
      <div className="max-w-7xl mx-auto flex flex-col">
        {/* Top Section: Grid for Logo/Contact & Navigation Links */}
